package net.Aboufariss.accountservice.web;

import net.Aboufariss.accountservice.clients.CustomerRestClient;
import net.Aboufariss.accountservice.entities.BankAccount;
import net.Aboufariss.accountservice.model.Customer;
import net.Aboufariss.accountservice.repository.BankAccountRepository;
